...
在 int(11)中的11仅代表显示长度为11，不影响存储空间
...
InnoDB通过MVCC解决快照读下的幻读，通过[[Database.1.Mysql学习#行级加锁\|行级加锁]]解决当前读情况下的幻读，两种方法很大程度上避免了幻读，但是[**没能完全解决幻读**](https://xiaolincoding.com/mysql/transaction/phantom.html#%E5%B9%BB%E8%AF%BB%E8%A2%AB%E5%AE%8C%E5%85%A8%E8%A7%A3%E5%86%B3%E4%BA%86%E5%90%97)
...
创建数据库连接是一个很耗时的操作，MySQL 短连接每次请求操作数据库都需要建立与 MySQL 服务器建立 TCP 连接，这是需要时间开销的，TCP 连接需要3次握手，增加了一定的延时和额外的 IO 消耗，在并发量非常大的情况会有影响
